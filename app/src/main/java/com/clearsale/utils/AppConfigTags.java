...
public class AppConfigTags {
    ...
    public static String PROPERTY_BATHROOMS = "property_bathrooms";
    ...
    public static String TESTIMONIAL_ID = "testimonial_id";
    public static String TESTIMONIAL_DESCRIPTION = "testimonial_description";
    public static String TESTIMONIAL_CLIENT_NAME = "testimonial_client_name";
    public static String TESTIMONIAL_URL = "testimonial_url";
