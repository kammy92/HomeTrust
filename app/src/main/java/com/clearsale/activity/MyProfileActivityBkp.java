...
public class MyProfileActivityBkp extends AppCompatActivity {
    EditText etFullName;
    EditText etEmail;
    EditText etPhone;
    CheckBox cb1;
...
//        getStateListFromServer();
    ...
    private void getPreferencesData () {
        etFullName.setText (buyerDetailsPref.getStringPref (MyProfileActivityBkp.this, BuyerDetailsPref.BUYER_NAME).trim ());
        etEmail.setText (buyerDetailsPref.getStringPref (MyProfileActivityBkp.this, BuyerDetailsPref.BUYER_EMAIL));
        etPhone.setText (buyerDetailsPref.getStringPref (MyProfileActivityBkp.this, BuyerDetailsPref.BUYER_MOBILE));
        
        String stateName[] = buyerDetailsPref.getStringPref (MyProfileActivityBkp.this, BuyerDetailsPref.PROFILE_STATE).trim ().split (",");
        
        String priceRange[] = buyerDetailsPref.getStringPref (MyProfileActivityBkp.this, BuyerDetailsPref.PROFILE_PRICE_RANGE).trim ().split (",");
        ...
        if (buyerDetailsPref.getStringPref (MyProfileActivityBkp.this, BuyerDetailsPref.PROFILE_HOME_TYPE).equalsIgnoreCase (spinnerItems[1])) {
            spinner.setSelectedIndex (1);
        } else if (buyerDetailsPref.getStringPref (MyProfileActivityBkp.this, BuyerDetailsPref.PROFILE_HOME_TYPE).equalsIgnoreCase (spinnerItems[2])) {
            spinner.setSelectedIndex (2);
        } else if (buyerDetailsPref.getStringPref (MyProfileActivityBkp.this, BuyerDetailsPref.PROFILE_HOME_TYPE).equalsIgnoreCase (spinnerItems[3])) {
            spinner.setSelectedIndex (3);
        } else if (buyerDetailsPref.getStringPref (MyProfileActivityBkp.this, BuyerDetailsPref.PROFILE_HOME_TYPE).equalsIgnoreCase (spinnerItems[4])) {
    ...
    private void initData () {
        progressDialog = new ProgressDialog (MyProfileActivityBkp.this);
        ...
        stateList.clear ();
        String allState[] = buyerDetailsPref.getStringPref (MyProfileActivityBkp.this, BuyerDetailsPref.STATE_LIST).trim ().split (",");
...
//        stateList.add ("WA");
    ...
    private void initListener () {
        ...
        spinner.setOnClickListener (new View.OnClickListener () {
            @Override
            public void onClick (View v) {
                Utils.hideSoftKeyboard (MyProfileActivityBkp.this);
            }
        });
        ...
        tvSave.setOnClickListener (new View.OnClickListener () {
            ...
            public void onClick (View view) {
                ...
                s.setSpan (new TypefaceSpan (MyProfileActivityBkp.this, Constants.font_name), 0, s.length (), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                SpannableString s2 = new SpannableString (getResources ().getString (R.string.please_enter_email));
                s2.setSpan (new TypefaceSpan (MyProfileActivityBkp.this, Constants.font_name), 0, s2.length (), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                SpannableString s3 = new SpannableString (getResources ().getString (R.string.please_enter_valid_email));
                s3.setSpan (new TypefaceSpan (MyProfileActivityBkp.this, Constants.font_name), 0, s3.length (), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                SpannableString s4 = new SpannableString (getResources ().getString (R.string.please_enter_mobile));
                s4.setSpan (new TypefaceSpan (MyProfileActivityBkp.this, Constants.font_name), 0, s4.length (), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                SpannableString s5 = new SpannableString (getResources ().getString (R.string.please_select_state_type));
                s5.setSpan (new TypefaceSpan (MyProfileActivityBkp.this, Constants.font_name), 0, s5.length (), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                SpannableString s6 = new SpannableString (getResources ().getString (R.string.please_select_home_type));
                s6.setSpan (new TypefaceSpan (MyProfileActivityBkp.this, Constants.font_name), 0, s6.length (), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                ...
                if (etFullName.getText ().toString ().trim ().length () == 0 && etEmail.getText ().toString ().length () == 0 && etPhone.getText ().toString ().length () == 0) {
                    ...
                    Utils.showSnackBar (MyProfileActivityBkp.this, clMain, s5.toString (), Snackbar.LENGTH_LONG, null, null);
                } else if (spinner.getText ().toString ().trim ().equalsIgnoreCase (spinnerItems[0])) {
                    Utils.showSnackBar (MyProfileActivityBkp.this, clMain, s6.toString (), Snackbar.LENGTH_LONG, null, null);
                } else {
    ...
    private void sendProfileDetailsToServer (final String name, final String email, final String mobile, final String homeType, final String state, final String budget) {
        if (NetworkConnection.isNetworkAvailable (MyProfileActivityBkp.this)) {
            ...
            StringRequest strRequest1 = new StringRequest (Request.Method.POST, AppConfigURL.URL_EDIT_PROFILE,
                        ...
                        public void onResponse (String response) {
                            ...
                            if (response != null) {
                                try {
                                    ...
                                    if (! error) {
                                        buyerDetailsPref.putStringPref (MyProfileActivityBkp.this, BuyerDetailsPref.BUYER_NAME, jsonObj.getString (AppConfigTags.BUYER_NAME));
                                        buyerDetailsPref.putStringPref (MyProfileActivityBkp.this, BuyerDetailsPref.BUYER_MOBILE, jsonObj.getString (AppConfigTags.BUYER_MOBILE));
                                        buyerDetailsPref.putStringPref (MyProfileActivityBkp.this, BuyerDetailsPref.PROFILE_HOME_TYPE, jsonObj.getString (AppConfigTags.PROFILE_HOME_TYPE));
                                        ...
                                        buyerDetailsPref.putStringPref (MyProfileActivityBkp.this, BuyerDetailsPref.PROFILE_PRICE_RANGE, jsonObj.getString (AppConfigTags.PROFILE_PRICE_RANGE));
                                        buyerDetailsPref.putIntPref (MyProfileActivityBkp.this, BuyerDetailsPref.PROFILE_STATUS, jsonObj.getInt (AppConfigTags.PROFILE_STATUS));
                                        new MaterialDialog.Builder (MyProfileActivityBkp.this)
                                                .content (message)
                                                .positiveText ("OK")
                                        ...
                                        Utils.showSnackBar (MyProfileActivityBkp.this, clMain, message, Snackbar.LENGTH_LONG, null, null);
                                    }
                                    progressDialog.dismiss ();
                                } catch (Exception e) {
                                    progressDialog.dismiss ();
                                    Utils.showSnackBar (MyProfileActivityBkp.this, clMain, getResources ().getString (R.string.snackbar_text_exception_occurred), Snackbar.LENGTH_LONG, getResources ().getString (R.string.snackbar_action_dismiss), null);
                                    e.printStackTrace ();
                                }
                            } else {
                                Utils.showSnackBar (MyProfileActivityBkp.this, clMain, getResources ().getString (R.string.snackbar_text_error_occurred), Snackbar.LENGTH_LONG, getResources ().getString (R.string.snackbar_action_dismiss), null);
                ...
                protected Map<String, String> getParams () throws AuthFailureError {
                    ...
                    params.put (AppConfigTags.BUYER_ID, String.valueOf (buyerDetailsPref.getIntPref (MyProfileActivityBkp.this, BuyerDetailsPref.BUYER_ID)));
